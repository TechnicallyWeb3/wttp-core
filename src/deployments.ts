...
type ContractTypes = 'gateway' | 'dps' | 'dpr';

export function getDeploymentInfo(chainId: number, contract: ContractTypes = 'gateway') {
  if (contract !== 'gateway') {
    return esp.getDeploymentInfo(chainId, contract);
  }
